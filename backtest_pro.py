...
# Ongeza limit hadi 5000 ili uone trades nyingi zaidi za siku kadhaa
bars = exchange.fetch_ohlcv(SYMBOL, timeframe='1m', limit=2000)
...
for t in trade_log:
    ...
    # Inaonyesha tarehe na muda sasa
